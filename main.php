...
if (mb_strlen($query) < 3 ||
    ...
    elseif (substr_count($query, '⇾') == 1) {
        ...
        if ($is_displaymorefrom_active == true) {
            $w->result('', serialize(array('' /*track_uri*/ ,'' /* album_uri */ ,'' /* artist_uri */ ,'' /* playlist_uri */ ,'' /* spotify_command */ ,'' /* query */ ,'' /* other_settings*/ , 'disable_displaymorefrom' /* other_action */ ,'' /* alfred_playlist_uri */ ,''  /* artist_name */)), "Disable \"Now Playing\"", "Disable display of various options based on current track", './images/' . $theme . '/' . 'uncheck.png', 'yes', '');
        } else {
            $w->result('', serialize(array('' /*track_uri*/ ,'' /* album_uri */ ,'' /* artist_uri */ ,'' /* playlist_uri */ ,'' /* spotify_command */ ,'' /* query */ ,'' /* other_settings*/ , 'enable_displaymorefrom' /* other_action */ ,'' /* alfred_playlist_uri */ ,''  /* artist_name */)), "Enable \"Now Playing\"", "Enable display of various options based on current track", './images/' . $theme . '/' . 'check.png', 'yes', '');
        }
