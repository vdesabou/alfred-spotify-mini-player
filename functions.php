...
function handleDbIssue($theme) {
	$w = new Workflows();
    $w->result('', '', 'There is a problem with the library, try to update it.', 'Select Update library below', './images/warning.png', 'no', array('copy' => 'Copy value','largetype' => 'Largetype value'), '');
