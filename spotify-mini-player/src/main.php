    ...
    if (substr_count($query, '▹') == 0) {
        ...
        if ($is_spotifious_active == true) {
            $w->result(null, serialize(array(
                ...
                $query /* query */ ,
                '' /* other_settings*/ ,
                'search_in_spotifious' /* other_action */ ,
                $alfred_playlist_uri /* alfred_playlist_uri */ ,
                '' /* artist_name */ ,
                '' /* track_name */ ,
                '' /* album_name */ ,
                ...
                $userid
                /* userid*/
            )), "Search for " . $query . " with Spotifious", array(
                ...
                'fn' => 'Not Available',
                'ctrl' => 'Not Available'
            ), './images/spotifious.png', 'yes', null, '');
        }
    }
    ////////////
    //
    ...
    elseif (substr_count($query, '▹') == 1) {
        ...
        elseif ($kind == "Alfred Playlist") {
            ...
            if (substr_count($query, '@') == 1) {
                ...
                $w->result(null, '', "Display biography " . escapeQuery($results[0]), "This will display the artist biography", './images/biography.png', 'no', null, "Biography▹" . $artist_uri . '∙' . escapeQuery($artist_name));
            ...
            if (substr_count($query, '∙') == 1) {
				...
				if($biography_url != false) {
                    ...
                    $w->result(null, serialize(array(
                        ...
                        $userid
                        /* userid*/
                    )), 'See biography for ' . $artist_name . ' on ' . $source, "This will open your default browser", './images/biography.png', 'yes', null, '');

					$wrapped = wordwrap($biography, 82, "\n", false);
            ...
            if ($is_spotifious_active == true) {
                $w->result(null, serialize(array(
                    ...
                    '' /* query */ ,
                    '' /* other_settings*/ ,
                    'disable_spotifiuous' /* other_action */ ,
                    $alfred_playlist_uri /* alfred_playlist_uri */ ,
                    '' /* artist_name */ ,
                    '' /* track_name */ ,
                    '' /* album_name */ ,
                    ...
                    'fn' => 'Not Available',
                    'ctrl' => 'Not Available'
                ), './images/disable_spotifious.png', 'yes', null, '');
            } else {
                $w->result(null, serialize(array(
                    '' /*track_uri*/ ,
                    '' /* album_uri */ ,
                    ...
                    '' /* query */ ,
                    '' /* other_settings*/ ,
                    'enable_spotifiuous' /* other_action */ ,
                    $alfred_playlist_uri /* alfred_playlist_uri */ ,
                    '' /* artist_name */ ,
                    '' /* track_name */ ,
                    '' /* album_name */ ,
                    ...
                    'fn' => 'Not Available',
                    'ctrl' => 'Not Available'
                ), './images/enable_spotifious.png', 'yes', null, '');
            }
        ...
        if ($kind == "Artist") {
            ...
            if ($is_spotifious_active == true) {
                $w->result(null, serialize(array(
                    ...
                    $userid
                    /* userid*/
                )), "Search for " . $artist_name . " with Spotifious", array(
                    'Spotifious workflow must be installed and script filter set with <spotifious>',
                    'alt' => 'Not Available',
                    'cmd' => 'Not Available',
                    'shift' => 'Not Available',
            ...
            if ($noresult) {
                ...
                if ($is_spotifious_active == true) {
                    $w->result(null, serialize(array(
                        ...
                        $userid
                        /* userid*/
                    )), "Search for " . $album_name . " with Spotifious", array(
                        'Spotifious workflow must be installed and script filter set with <spotifious>',
                        'alt' => 'Not Available',
                        'cmd' => 'Not Available',
                        'shift' => 'Not Available',
            ...
            if (mb_strlen($thetrack) > 0) {
                ...
                if ($is_spotifious_active == true) {
                    $w->result(null, serialize(array(
                        ...
                        $userid
                        /* userid*/
                    )), "Search for " . $thetrack . " with Spotifious", array(
                        'Spotifious workflow must be installed and script filter set with <spotifious>',
                        'alt' => 'Not Available',
                        'cmd' => 'Not Available',
                        'shift' => 'Not Available',
