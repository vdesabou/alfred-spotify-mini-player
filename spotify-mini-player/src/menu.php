...
function searchCommandsFastAccess($w, $query, $settings, $db, $update_in_progress)
{
    ...
    if (mb_strlen($query) < 3) {
        ...
        } elseif (strpos(strtolower('play'), strtolower($query)) !== false) {
            $w->result(null, serialize(array(
                '' /*track_uri*/ ,
                '' /* album_uri */ ,
                '' /* artist_uri */ ,
        ...
        } elseif (strpos(strtolower('pause'), strtolower($query)) !== false) {
            $w->result(null, serialize(array(
                '' /*track_uri*/ ,
                '' /* album_uri */ ,
                '' /* artist_uri */ ,
        ...
        } elseif (strpos(strtolower('current'), strtolower($query)) !== false) {
            $w->result(null, serialize(array(
                '' /*track_uri*/ ,
                '' /* album_uri */ ,
                '' /* artist_uri */ ,
        ...
        } elseif (strpos(strtolower('random'), strtolower($query)) !== false) {
            $w->result(null, serialize(array(
                '' /*track_uri*/ ,
                '' /* album_uri */ ,
                '' /* artist_uri */ ,
        ...
        } elseif (strpos(strtolower('shuffle'), strtolower($query)) !== false) {
            $w->result(null, serialize(array(
                '' /*track_uri*/ ,
                '' /* album_uri */ ,
                '' /* artist_uri */ ,
        ...
        } elseif (strpos(strtolower('refresh'), strtolower($query)) !== false) {
            if ($update_in_progress == false) {
                $w->result(null, serialize(array(
                    '' /*track_uri*/ ,
                    '' /* album_uri */ ,
        ...
        } elseif (strpos(strtolower('update'), strtolower($query)) !== false) {
            if ($update_in_progress == false) {
                $w->result(null, serialize(array(
                    '' /*track_uri*/ ,
                    '' /* album_uri */ ,
        ...
        } elseif (strpos(strtolower('add'), strtolower($query)) !== false) {
            if ($update_in_progress == false) {
                if ($is_alfred_playlist_active == true) {
                    $w->result(null, serialize(array(
                        '' /*track_uri*/ ,
        ...
        } elseif (strpos(strtolower('volume_down'), strtolower($query)) !== false) {
            $w->result(null, serialize(array(
                '' /*track_uri*/ ,
                '' /* album_uri */ ,
                '' /* artist_uri */ ,
        ...
        } elseif (strpos(strtolower('volume_up'), strtolower($query)) !== false) {
            $w->result(null, serialize(array(
                '' /*track_uri*/ ,
                '' /* album_uri */ ,
                '' /* artist_uri */ ,
 ...
 * @return void
 */
function firstDelimiterOnline($w, $query, $settings, $db, $update_in_progress)
{
    $words = explode('▹', $query);
    $kind  = $words[0];
...
/**
 * firstDelimiterOnlineRelated function.
 *
 * @access public
 * @param mixed $w
 * @param mixed $query
 ...
 * @return void
 */
function firstDelimiterOnlineRelated($w, $query, $settings, $db, $update_in_progress)
{
    $words = explode('▹', $query);
    $kind  = $words[0];
...
/**
 * firstDelimiterFollowUnfollow function.
 *
 * @access public
 * @param mixed $w
 * @param mixed $query
 ...
 * @return void
 */
function firstDelimiterFollowUnfollow($w, $query, $settings, $db, $update_in_progress)
{
    $words = explode('▹', $query);
    $kind  = $words[0];
...
/**
 * firstDelimiterFollowOrUnfollow function.
 *
 * @access public
 * @param mixed $w
 * @param mixed $query
 ...
 * @return void
 */
function firstDelimiterFollowOrUnfollow($w, $query, $settings, $db, $update_in_progress)
{
    $words = explode('▹', $query);
    $kind  = $words[0];
